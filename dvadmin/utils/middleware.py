...
class ApiLoggingMiddleware(MiddlewareMixin):
    """
    Middleware for recording API access logs
    """
    ...
    def __handle_response(self, request, response):
        # request_data, request_ip attributes added by PermissionInterfaceMiddleware
        body = getattr(request, 'request_data', {})
        # Replace password with * if present (applied to all interface password params for now)
    ...
    def process_response(self, request, response):
        """
        Mainly records after request processing is complete
        :param request:
        :param response:
        :return:
        """
