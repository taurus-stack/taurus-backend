# Generated by Django 4.2.30 on 2026-07-02 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "login_error_count",
                    models.IntegerField(
                        default=0, help_text="登录错误次数", verbose_name="登录错误次数"
                    ),
                ),
                (
                    "creator",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sort",
                    models.IntegerField(
                        default=1, help_text="显示排序", verbose_name="显示排序"
                    ),
                ),
                (
                    "owner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_catalog",
                    models.BooleanField(
                        default=False, help_text="是否目录", verbose_name="是否目录"
                    ),
                ),
                (
                    "web_path",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_system_menu_button",
                "ordering": ("-name",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="标题", max_length=100, verbose_name="标题"
                    ),
                ),
                ...
                (
                    "target_type",
                    models.IntegerField(
                        default=0, help_text="目标类型", verbose_name="目标类型"
                    ),
                ),
                (
                    "creator",
            ...
            options={
                ...
                "db_table": "taurus_message_center",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sort",
                    models.IntegerField(
                        default=1, help_text="角色顺序", verbose_name="角色顺序"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_role_menu_permission",
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_role_menu_button_permission",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="岗位名称", max_length=64, verbose_name="岗位名称"
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="岗位编码", max_length=32, verbose_name="岗位编码"
                    ),
                ),
                (
                    "sort",
                    models.IntegerField(
                        default=1, help_text="岗位顺序", verbose_name="岗位顺序"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_system_operation_log",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_message_center_target_user",
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field_name",
                    models.CharField(max_length=64, verbose_name="模型表字段名"),
                ),
            ...
            options={
                ...
                "db_table": "taurus_system_menu_field",
                "ordering": ("id",),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_system_login_log",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=dvadmin.system.models.media_file_name,
                    ),
                ),
                (
                    "file_url",
            ...
            options={
                ...
                "db_table": "taurus_system_file_list",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_create",
                    models.BooleanField(default=1, verbose_name="是否可创建"),
                ),
                (
                    "is_update",
                    models.BooleanField(default=1, verbose_name="是否可更新"),
                ),
                (
                    "creator",
                    models.ForeignKey(
            ...
            options={
                ...
                "db_table": "taurus_system_field_permission",
                "ordering": ("id",),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_system_dictionary",
                "ordering": ("sort",),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="名称", max_length=100, verbose_name="名称"
                    ),
                ),
                (
                    "code",
                ...
                (
                    "pinyin",
                    models.CharField(
                        help_text="拼音", max_length=255, verbose_name="拼音"
                    ),
                ),
                (
                    "initials",
                    models.CharField(
                        help_text="首字母", max_length=20, verbose_name="首字母"
                    ),
                ),
                (
                    "enable",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "taurus_api_white_list",
                "ordering": ("-create_datetime",),
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="标题", max_length=50, verbose_name="标题"
                    ),
                ),
                (
                    "key",
                    models.CharField(
                        db_index=True, help_text="键", max_length=100, verbose_name="键"
                    ),
                ),
                (
                    "value",
                ...
                (
                    "sort",
                    models.IntegerField(
                        blank=True, default=0, help_text="排序", verbose_name="排序"
                    ),
                ),
                (
                    "status",
                    models.BooleanField(
                        default=True, help_text="启用状态", verbose_name="启用状态"
                    ),
                ),
                (
                    "data_options",
                ...
                (
                    "setting",
                    models.JSONField(
                        blank=True, help_text="配置", null=True, verbose_name="配置"
                    ),
                ),
                (
                    "creator",
