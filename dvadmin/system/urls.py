...
from dvadmin.system.views.dictionary import DictionaryViewSet, HostTypeDictionaryViewSet
...
system_url.register(r'permission_code', PermissionCodeViewSet)
system_url.register(r'role_permission', RolePermissionViewSet)
...
urlpatterns = [
    ...
    path('dept/tree/', DeptViewSet.as_view({'get': 'tree'})),
    path('clause/privacy.html', PrivacyView.as_view()),
    path('clause/terms_service.html', TermsServiceView.as_view()),
    path('dict/host_type/', HostTypeDictionaryViewSet.as_view()),
]
